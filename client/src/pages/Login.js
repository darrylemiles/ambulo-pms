...
import Logo from '../assets/logo-property.png'
  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        .secondary-property {
          background: linear-gradient(135deg, #a18870 0%, #8d7163 100%);
          border-radius: 16px;
          width: 260px;
          height: 380px;
        ...
        .secondary-property::before {
          font-size: 32px;
        }

        .third-property{
          background: linear-gradient(135deg, #ffb366 0%, #ff8a50 100%);
          border-radius: 16px;
          width: 260px;
          height: 380px;
          margin-top: 40px;
        ...
        .form-input-account:focus {
          border-color:rgb(50, 52, 54);
          background: white;
          box-shadow: 0 0 0 3px rgba(74, 144, 226, 0.1);
        }

        .form-input-account::placeholder {
      ...
      <div className="container">
        <div className="left-section">
          <div className="welcome-content">
            ...
            <div className="brand-name">Ambulo's Property</div>
          </div>
          ...
          <div className="property-showcase">
            ...
            <div className="secondary-property">
              <img 
          ...
          <div className="login-card">
            <div className="login-icon">
              <div style={{
                ...
                <img src= {Logo} alt="Ambulo Properties logo" style={{ width: '60px', height: '60px' }}
                />
              </div>
            </div>

            <h2 className="login-title">Please Login your account</h2>

            <div>
              <div className="form-group-login">
                <input type="email" className="form-input-account" placeholder="Email" />
              </div>
