...
let messages = [
  {
    ...
    preview:
      "Hi team, I wanted to provide you with an update on our Q4 project progress. We've made significant headway...",
    date: "2024-01-15",
    time: "14:30",
    read: false,
    starred: true,
  ...
  },
  {
    ...
    preview:
      "Don't forget about our scheduled meeting tomorrow at 3PM in the conference room. We'll be discussing...",
    date: "2024-01-15",
    time: "10:15",
    read: true,
    starred: false,
  ...
  },
  {
    ...
    preview:
      "I hope this email finds you well. I'm reaching out regarding a potential collaboration opportunity that could...",
    date: "2024-01-14",
    time: "16:45",
    read: false,
    starred: false,
  ...
  },
  {
    ...
    preview:
      "Thank you for sharing the latest design mockups. I've reviewed them thoroughly and have some feedback...",
    date: "2024-01-14",
    time: "09:20",
    read: true,
    starred: true,
...
function renderListView() {
  ...
  messages.forEach((message, index) => {
    ...
    row.className = `message-row ${message.read ? "" : "unread"} ${
    ...
    row.innerHTML = `
                    ...
                    <div class="sender">
                        <div class="avatar ${message.avatarColor}">${
      message.avatar
    }</div>
    ...
    card.innerHTML = `
                    <div class="card-header">
                        <div class="card-sender">
                            <div class="card-avatar ${message.avatarColor}">${
      message.avatar
    }</div>
                            <div class="card-sender-info">
                                ...
                                <div class="card-date">${message.date} ${
      message.time
    }</div>
                            </div>
                        </div>
...
function selectUnreadMessages() {
  ...
  messages
    .filter((m) => !m.read)
    .forEach((message) => selectedMessages.add(message.id));
  renderMessages();
  updateSelectionCount();
  updateSelectAllCheckboxes();
  hideSelectAllDropdown();
